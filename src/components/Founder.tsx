...
const Founder: React.FC = () => {
  // Pointing to the local image as requested.
  // Ensure 'will_lockard.jpg' is placed in the 'public/' directory.
  const founderImage = "/will_lockard.jpg"; 
  const fallbackImage = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=800&auto=format&fit=crop";

  const [imgSrc, setImgSrc] = useState(founderImage);
            ...
            <div className="relative group mx-auto lg:mx-0 max-w-md lg:max-w-none w-full">
                ...
                <div className="relative aspect-[3/4] w-full overflow-hidden rounded-sm shadow-2xl bg-gray-900 flex items-center justify-center border border-gray-200 dark:border-white/5">
                    <img 
                        ...
                        className="w-full h-full object-cover object-top group-hover:scale-[1.03] transition-transform duration-700 filter grayscale contrast-125 hover:grayscale-0"
                    />
